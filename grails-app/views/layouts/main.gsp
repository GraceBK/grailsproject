...
<head>
    ...
    <g:set var="entityNameUser" value="${message(code: 'user.label', default: 'User')}" />
    <g:set var="entityNameRole" value="${message(code: 'role.label', default: 'Role')}" />
    <g:set var="entityNameMatch" value="${message(code: 'match.label', default: 'Match')}" />
    <g:set var="entityNameMessage" value="${message(code: 'message.label', default: 'Message')}" />
    <title>
...
<sec:ifLoggedIn>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" style="min-height: 80px">
        <a class="navbar-brand" href="${createLink(uri: '/')}">
            <asset:image src="grails.svg" alt="Grails Logo" width="30" height="30" class="d-inline-block align-top"/>
            Project Grails
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <sec:ifAnyGranted roles="ROLE_ADMIN">
                    <li class="nav-item"><g:link class="nav-link" action="create" controller="user"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <g:message code="default.new.label" args="[entityNameUser]" /></g:link></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuMatch">
                            <g:link class="dropdown-item" action="index" controller="match"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <g:message code="default.list.label" args="[entityNameMatch]" /></g:link>
                            <g:link class="dropdown-item" action="create" controller="match"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <g:message code="default.new.label" args="[entityNameMatch]" /></g:link>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuMessage">
                            <g:link class="dropdown-item" action="index" controller="message"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <g:message code="default.list.label" args="[entityNameMessage]" /></g:link>
                            <g:link class="dropdown-item" action="create" controller="message"><span class="glyphicon glyphicon-star" aria-hidden="true"></span> <g:message code="default.new.label" args="[entityNameMessage]" /></g:link>
                        </div>
                    </li>
                </sec:ifAnyGranted>
            </ul>
