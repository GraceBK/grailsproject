...
<div id="edit-user" class="container content scaffold-edit" role="main" style="padding-top: 70px">
    ...
    <g:uploadForm controller="user" action="update" resource="${this.user}" method="PUT" style="width: 300px">
        ...
        <div class="form-group">
            ...
            <g:field type="file" id="avatarFile" name="avatarFile" value="${avatar}"/>
        </div>
